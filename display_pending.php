...
<html lang="en">
	...
	<body>
		...
		<article>
			<h1>Display pending orders</h1>
			<form method="post" action = "display_pending.php">
		...
		<?php		
			...
			$query = "SELECT `order_id`, `order_time`, `firstname`, `lastname`, `movie`, `date`, `session`, `adult_ticket`, `student_ticket`, `child_ticket`, `senior_ticket`, `order_cost`, `order_status` FROM `$sql_table` WHERE `order_status`=\"pending\"";
